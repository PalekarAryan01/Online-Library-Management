...
if (isset($_SESSION['Fname'])) {
    ...
    // Handle the case where the user's first name is not set
    $user_name = "Guest"; // Default value or redirect to login page
}
?>
        ...
        function reserveBook(bookId) {
            ...
            xhr.onreadystatechange = function () {
                if (xhr.readyState == 4 && xhr.status == 200) {
                    ...
                    location.reload(); // Reload the page to update availability
                }
            };
...
<body>
     ...
     <div class="container">
        ...
        <ul>
                ...
                <li>
                     <a href="<?php echo ($_SESSION['role'] == 'admin') ? 'admin.php' : 'dashboard.php'; ?>">
                        <span class="icon">
        ...
        <div class="container-search">
            ...
            <p>Search for books, authors, or genres in our extensive library collection.</p>
            ...
            <div class="search-results">
                <h2>Reserve Your Book Here</h2>
                <div id="results" class="table">
                    <?php
                    if ($_SERVER["REQUEST_METHOD"] == "POST") {
                        $search = $_POST['search'];
                        $sql = "SELECT id, title, author, quantity FROM books WHERE title LIKE '%$search%' OR author LIKE '%$search%'";
